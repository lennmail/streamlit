...
st.title("Lenny's Tutorial App")
st.write("This is the best app ever, you better like it")
button1 = st.button("Do not Click Me")
if button1:
    st.write("Are you crazy?????.")
...
epochs_num2 = st.slider("How many pizzas could you eat?", 1,100, 10)
if st.button("Slider Button"):
    st.write(epochs_num)
    st.write(epochs_num2)
